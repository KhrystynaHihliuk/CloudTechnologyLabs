...
public partial class Form1 : Form
{
    ...
    public Form1()
    {
        ...
        InitializeUi();
        this.BackColor = Color.LightSkyBlue; // Set the background color to Light Blue
    ...
    private async void InitializeAzureStorage()
    {
        const string storageConnectionString =
            "DefaultEndpointsProtocol=https;AccountName=lab03storage;AccountKey=HDL30lMOStLIPeAED5BKCnKy7ziuZXa0QQ2zGSBFVYyVphL/FvLLp/nVH6fN5qReYoZWjHRi6Kn3+AStXQ0xbQ==;EndpointSuffix=core.windows.net";
